...
-- 4. Find the top 5 most-reviewed apps
...
-- 8. Find all records with a min install not exceeding 50, 
...
-- 9. Find the names of all apps that are rated less than 3
-- with atleast 10000 reviews

SELECT app_name FROM analytics
    WHERE rating < 3 AND reviews >= 10000;

-- 10. Find the top 10 most-reviewed apps that
