...
-- 1. Add a product to the table with the name of "chair", price of 44.00
...
-- 2. Add a product to the table with the name of "stool", price of 25.99,
-- and can_can_be_returned of true
